...
![A slightly more advanced version of Pong](./images/pong.gif) *A slightly more advanced version of Pong*
...
<Aside>
  <Image src="reactive-programming.jpg" alt="Use Reactive programming you must Yoda meme" />
</Aside>
...
<Aside>
  <Image src="blame-javascript.jpg" alt="I have no idea what I'm doing must blame javascript dog at computer meme" />
  <em>JavaScript the best language</em>
</Aside>
