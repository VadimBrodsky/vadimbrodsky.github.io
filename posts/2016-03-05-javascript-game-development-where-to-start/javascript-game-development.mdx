...
![Use Reactive programming you must Yoda meme](./images/reactive-programming.jpg)
...
![JavaScript the best* language](./images/blame-javascript.jpg)*JavaScript the best* language*
